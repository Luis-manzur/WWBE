    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='Hellp easily distinguish users and perform queries.', verbose_name='Active status')),
                ('is_verified', models.BooleanField(default=False, help_text='Set to true when the user hacve verified the email address.', verbose_name='verified')),
